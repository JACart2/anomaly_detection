...
bool anomaly_msg__msg__anomaly_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anomaly_msg.msg._anomaly_log.AnomalyLog", full_classname_dest, 39) == 0);
  }
  anomaly_msg__msg__AnomalyLog * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of AnomalyLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anomaly_msg.msg._anomaly_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnomalyLog");
